...
> {
  ...
  render() {
    ...
    return (
      <StageContainer direction={direction} ref={(dom) => (this.$host = dom!)}>
        <StageHeader
          direction={direction}
          onClick={this.toggle}
          css={css`
            &:before {
              ...
              box-shadow: inset 0 -80px 40px -60px ${primaryColor},
                inset 0 80px 40px -60px ${primaryColor};
            }
          `}
          style={{
        ...
        <Transition timeout={1000} in={this.state.open}>
          {(state) => (
            <StageContent
              css={[
                (state === "entered" || state === "entering") && enteredStyle,
                (state === "exited" || state === "exiting") && exitedStyle,
              ]}
